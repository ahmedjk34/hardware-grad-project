...
| `BUILD_PLACEMENT_OFFSET_X_CM` | **`−0.45`** | **`+0.6`** | Rig-calibrated. Vertical placements landed 0.45 cm too far from the X home switch. Horizontal: `−0.4` -> `+1.35` after the 2026 arm re-seat -> walked down to `+0.6` as it kept landing too far from home. |
| `BUILD_PLACEMENT_OFFSET_Y_CM` | **`−0.45`** | **`−0.35`** | Rig-calibrated. Vertical landed 0.45 cm too far from the Y home switch. Horizontal walked `−0.3` -> `−0.6` -> `−0.35`. |
