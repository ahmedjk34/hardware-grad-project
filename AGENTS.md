...
| `Z_PICKUP_DROP_FROM_TOP_CM` | `13.55` | `13.55` | not per mode — phase-5 pickup descends 13.55 cm below the top switch (≈ 13.0 cm above ground at the shipped Z calibration) onto the feeder belt, instead of ground-seeking |
