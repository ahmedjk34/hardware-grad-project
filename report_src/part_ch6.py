...
def appendices(rep):
    ...
    rep.table(
        ...
        [
            ...
            ["6", "output", "Gripper servo signal", "Claw jaws: OPEN 100 deg, CLOSE 180 deg"],
    ...
    rep.table(
        ...
        [
            ...
            ["`Z_MARGIN_FIXED_CM`", "+0.48 cm", "Added once at any level >= 1"],
            ...
            ["`SERVO_OPEN_ANGLE` / `SERVO_CLOSE_ANGLE`", "100 deg / 180 deg", "Claw jaws"],
            ...
            ["`BUILD_PLACEMENT_OFFSET_X_CM`", "-0.45 / +0.6 cm", "Vertical / horizontal fixed X correction, build motion only"],
