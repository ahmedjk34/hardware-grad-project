...
Z_PICKUP_DROP_FROM_TOP_CM = 13.55
check("rig sketch feeder pickup drop is 13.55 cm below the top switch",
...
for standalone_name in ("build_vertical_grid", "build_horizontal_grid"):
    ...
    check(f"{standalone_name} feeder pickup drop matches the rig sketch (13.55 cm)",
