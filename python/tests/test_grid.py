...
Z_PICKUP_DROP_FROM_TOP_CM = 12.0
check("rig sketch feeder pickup drop is 12.0 cm below the top switch",
...
for standalone_name in ("build_vertical_grid", "build_horizontal_grid"):
    ...
    check(f"{standalone_name} feeder pickup drop matches the rig sketch (12.0 cm)",
