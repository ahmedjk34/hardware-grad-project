...
height (`Z_PICKUP_DROP_FROM_TOP_CM`, 13.25 cm below the top switch ≈ a
675-step / ~1288 ms move at the shipped calibration). `zEtaToPickupMs()` sends
...
@12 STEP step=5 total=14 phase=lower_to_ground action=move text=Lower_Z_to_the_ground_switch status=begin ms=1288
...
@1 STEP step=5 total=14 phase=lower_to_ground action=move text=Lower_Z_to_the_ground_switch status=begin ms=1288
...
@3 STEP step=5 total=14 phase=lower_to_ground action=move text=Lower_Z_to_the_ground_switch status=begin ms=1288
