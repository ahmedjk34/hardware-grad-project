/*
  ...
  SERIAL COMMANDS
    ...
    0 = HOME / GO TO ORIGIN (drive into both switches)
...
bool axisHomed[AXIS_COUNT] = {false, false};
...
unsigned long moveAxisSteps(uint8_t axis, long deltaSteps)
{
    ...
    setDirection(MOVES[idx].dir1, MOVES[idx].dir2);
...
void printInstructions()
{
    ...
    Serial.println("0 = HOME / go to origin (both switches)");
    Serial.println("--------------------------------------");
    ...
    Serial.println("(G and S need a newline / Enter)");
    Serial.println("======================================");
}