...
// O/openServo() runs.
// Build gripper calibration. Open angle is 120 deg in this manual sketch
// (was 100; other sketches still 100) - both the feeder-home and the general
// open use it, so every open in the manual build cycle is 120.
