...
→ 65° → 23°, then open it through the same stages in reverse, wait for the
...
one-second settling interval. The stage angles make the three moves as uniform
as whole degrees allow: 42°, 43°, and 42°.
