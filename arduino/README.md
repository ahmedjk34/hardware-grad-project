...
rotation settings as `build_test_v1/`: open **90°**, close **144°**, fixed placement margin
...
X/Y home switches and opens to **90 degrees**. `C` closes it at
**144 degrees**. These are the Mega build gripper settings; the Uno feeder
