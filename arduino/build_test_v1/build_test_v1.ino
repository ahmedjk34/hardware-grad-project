...
//   Z_PICKUP_DROP_FROM_TOP_CM          13.55        (drop from TOP, see below)
//
...
//               live reference. 13.55 below top == ~13.0 above GROUND at
...
//        from ground  ==  a ~690-step descent from the top switch.
//
