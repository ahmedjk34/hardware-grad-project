...
//   Z_PICKUP_DROP_FROM_TOP_CM          12.0         (drop from TOP, see below)
//
...
//               live reference. 12.0 below top == ~14.5 above GROUND at
...
//        12.0 cm below top  ==  ~14.5 cm above GROUND  ==  ~739 steps
//        from ground  ==  a ~611-step descent from the top switch.
//
...
//   true GROUND zero.
float Z_PICKUP_DROP_FROM_TOP_CM = 12.0;
