...
| [ack-protocol.md](ack-protocol.md) | **partly built** | machine-readable `@` lines beside the human prose. The safety subset is in `build_test_v1` but has never been flashed; the Pi does not read it yet |
