...
| [dual-orientation-grid.md](dual-orientation-grid.md) | **active** | a second, equally valid grid: blocks laid horizontally 3 x 15 alongside the vertical 9 x 5, with per-mode geometry, trims and calibration, latched by `RR` / `R` |
