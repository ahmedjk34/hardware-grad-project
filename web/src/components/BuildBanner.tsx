  ...
  if (running) return (
    <section className="banner running" role="status">
      ...
      {!connected ? (
        ...
        <>
          <strong>{state.cell_phase === "awaiting_manual_close"
            ? "AWAITING ALIGNMENT" : "GANTRY PLACING"}</strong>
          <span className="detail">Mega gantry is moving and cannot be interrupted</span>
