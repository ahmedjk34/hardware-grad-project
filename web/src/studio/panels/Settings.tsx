  ...
  return (
    <section className="studio-settings" aria-labelledby="studio-settings-title">
      ...
      <label className="studio-setting" htmlFor="studio-support-ratio">
        ...
        <span className="studio-setting-copy">How much of a block's underside must rest on something. A guess about friction and the claw's release. Nobody has measured this rig. A block whose centre of mass falls outside its supports is rejected regardless of contact.</span>
      </label>
